...
GRID_SIZE = 80              # Pontos por dimensão para calcular densidade
GRID_RANGE = 8.0            # Extensão da caixa em unidades de Bohr (±8 a.u.)
ISO_VALUE = 0.02            # Isosurface: |ψ|² = 2% do máximo
...
MIN_Z = 1
MAX_Z = 54          # Até Xenônio (limite prático)
